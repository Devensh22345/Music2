...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Devensh22345/Music2",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/DKXBOT_group")
